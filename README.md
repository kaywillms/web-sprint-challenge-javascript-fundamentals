...
1. Briefly compare and contrast `.forEach` & `.map` (2-3 sentences max)
   ForEach is the returning value.
   Unlike forEach, Map returns a new array.

2. Explain the difference between a callback and a higher order function.
   A higher order function accepts another function as an argument a callback function is passed to another function to be called

3. What is closure?
   a conbination of function used together
